...
if (document.querySelector('.calc')) {
  ...
  var count = 0;
  var kf = 0;
  var slider = document.querySelector('.calc__pages');
  var tip = document.querySelector('.calc__tip');
  /*const sliderOptions = [{
          title: 'до 5',
          kf: 1
      },
  ...
  if (slider) {
    nouislider__WEBPACK_IMPORTED_MODULE_2___default.a.create(slider, _defineProperty({
      start: [1],
      connect: true,
      step: 1,
      range: {
